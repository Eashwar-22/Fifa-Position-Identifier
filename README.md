...
* Create a web application for the project, providing the attributes as an input from which the ideal position is printed as the output. <br><br>
---
**Deployed App**

<a href="https://fifa22-position-identifier.herokuapp.com/" target="_blank">Link1</a> <br>
<a href="https://share.streamlit.io/eashwar-22/fifa-position-identifier/main/app.py" target="_blank">Link2</a>
